...
export default {
  ...
  // Resolve TS path aliases used in the monorepo
  moduleNameMapper: {
    '^@nextgen-marketplace/(.*)$': '<rootDir>/../../libs/$1/src/index.ts',
    '^@nextgen-marketplace$': '<rootDir>/../../',
  },
  moduleFileExtensions: ['ts', 'js', 'html'],
  testEnvironment: 'node',
  coverageDirectory: '../coverage/ai-recommendations',
};
